...
const Download = (url, options, callback) => {
    ...
    Flow(function*(cb) {
        ...
        const cachePrefix = options ? options.cachePrefix : null;
        const showProgressbar = options ? options.showProgressbar : false;
        const progressCallback = options ? options.progressCallback : null;
